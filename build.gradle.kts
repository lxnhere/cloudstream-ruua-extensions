...
subprojects {
    ...
    cloudstream {
        ...
        setRepo(System.getenv("GITHUB_REPOSITORY") ?: "https://github.com/lxnhere/cloudstream-ruua-extensions")
        authors = listOf("lxnhere", "CakesTwix", "Hexated")
    }
    ...
    dependencies {
        ...
        implementation(libs.jackson.module.kotlin) // hexated RU providers
    }
